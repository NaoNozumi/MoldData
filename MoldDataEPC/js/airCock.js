...
const COCK_A_S = 176; // A:1~19
const COCK_B_S = 208; // B:A~W
const COCK_C_S = 240 + cockFlow_NUM - 1; // C:A~W
const COCK_D_S = 272; // D:1~19
...
function airCockDraw() {
	...
	for (i = 0; i < cockWidth_NUM; i++) {
		//
		((i % 2) == 0) ? p = COCK_A_S + o: p = COCK_A_S + cockWidth_NUM - 1 - o;
		((i % 2) == 0) ? q = COCK_D_S + o: q = COCK_D_S + cockWidth_NUM - 1 - o;
		(dataList[p] == 1) ? cockCanvasCtx.fillStyle = "#ffbf00": cockCanvasCtx.fillStyle = "#ffffff"; // 色
		cockCanvasCtx.fillRect(xx, i * holePitchPX + yy, j, holePitchPX);
		cockCanvasCtx.strokeRect(xx, i * holePitchPX + yy, j, holePitchPX);
		// 反転
		(dataList[q] == 1) ? cockCanvasCtx.fillStyle = "#ffbf00": cockCanvasCtx.fillStyle = "#ffffff"; // 色
	...
	for (i = 0; i < cockWidth_NUM; i++) {
		...
		((i % 2) == 0) ? p = COCK_A_S + o: p = COCK_A_S + cockWidth_NUM - 1 - o;
		((i % 2) == 0) ? q = COCK_D_S + o: q = COCK_D_S + cockWidth_NUM - 1 - o;
		(dataList[p] == 1) ? cockCanvasCtx.fillStyle = "#ffbf00": cockCanvasCtx.fillStyle = "#bfbfbf"; // 色
		...
		// 反転
		(dataList[q] == 1) ? cockCanvasCtx.fillStyle = "#ffbf00": cockCanvasCtx.fillStyle = "#bfbfbf"; // 色
	...
	for (i = 0; i < cockFlow_NUM; i++) {
		//
		(dataList[COCK_B_S + i] == 1) ? cockCanvasCtx.fillStyle = "#ffbf00": cockCanvasCtx.fillStyle = "#ffffff"; // 色
		cockCanvasCtx.fillRect(i * holePitchPX + xx, y, holePitchPX, j);
		cockCanvasCtx.strokeRect(i * holePitchPX + xx, y, holePitchPX, j);
		// 反転
		(dataList[COCK_C_S - i] == 1) ? cockCanvasCtx.fillStyle = "#ffbf00": cockCanvasCtx.fillStyle = "#ffffff"; // 色
	...
	for (i = 0; i < cockFlow_NUM; i++) {
		//
		(dataList[COCK_B_S + i] == 1) ? cockCanvasCtx.fillStyle = "#ffbf00": cockCanvasCtx.fillStyle = "#bfbfbf"; // 色
		...
		// 反転
		(dataList[COCK_C_S - i] == 1) ? cockCanvasCtx.fillStyle = "#ffbf00": cockCanvasCtx.fillStyle = "#bfbfbf"; // 色
